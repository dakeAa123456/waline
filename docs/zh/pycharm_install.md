...
7. 启动 pycharm，首次启动提示点击“Continue”-> Don't Send，然后选择点击 Activate PyCharm 激活按钮
   ![本地目录](../public/images/python008.png)
...
![本地目录](../public/images/python010.jpg)
