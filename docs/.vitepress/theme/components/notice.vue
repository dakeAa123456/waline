...
setTimeout(function(){ visible.value = false }, 5000000);
</script>
...
<template>
    <div v-if="visible" class="bulletin-wrapper" style="width: 300px;">
        ...
        <div class="bulletin-content">
            ...
            <img class="bulletin-img"src="/images/vuepress-reco.png">
            <hr>
            <div class="btn-group">
...
.bulletin-wrapper {
    ...
    overflow-y: auto;
    background-color: rgba(93, 103, 232, 1);
...
hr {
    ...
    border-style: solid;
    border-color: rgba(93, 103, 232, 1);
}
